...
class SEOEditorAdmin extends ModelAdmin
{
     ...
     * @var string
     */
    private static $menu_icon = 'silverstripe-seo-editor-fluent/images/seo-editor-icon.png';
    /**
     * @var array
     */
    ...
    {
        parent::init();
        Requirements::css('silverstripe-seo-editor-fluent/css/seo-editor.css');
        Requirements::javascript('silverstripe-seo-editor-fluent/javascript/seo-editor.js');
    }
